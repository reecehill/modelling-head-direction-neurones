...
class Panoramic(QtWidgets.QWidget):
    def __init__(self, imagePath):
        ...
        self.viewingWidth = self.width()  # length of arc
        self.viewingDistance = (self.source.width() / pi) / 2 #radius of circle
        self.viewingAngleAtT0 = self.viewingWidth / (pi * 2*self.viewingDistance) # theta of sector 
